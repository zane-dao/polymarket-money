...
function artifact(runId: string, start: string, end: string, jNet: string): unknown {
  const report = {
    ...
    run: { runId, collectorGitCommit: "a".repeat(40), targetMarketCount: 1, firstFullMarketStart: start, captureEnd: end, journalPath: "/tmp/kj-inputs.ndjson", journalRecordCount: "10", journalLastRecordHash: "b".repeat(64), resultKind: "INITIAL" as const },
